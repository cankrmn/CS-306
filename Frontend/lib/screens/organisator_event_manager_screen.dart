...
class _OrganisatorEventManagerScreenState
  ...
  fetchOrganiserEvents(String searchKey) async {
    ...
    final response = await http.get(
      Uri.parse(
          "http://127.0.0.1:5000/event/organiserEvents/?email=" + searchKey),
      headers: {
  ...
  deleteEvent(int id) {
    final response = http.get(
      Uri.parse("http://127.0.0.1:5000/event/delete/?id=" + id.toString()),
      headers: {
        'Accept': 'application/json; charset=UTF-8',
      },
    );
              ...
              ElevatedButton(
                  ...
                  onPressed: () async {
                    var reqBody = {
                      ...
                      "date": (DateFormat("yyyy-MM-dd").format(eventStartDate)).toString(),
                      ...
                      "duration":
                          eventEndDate.difference(eventStartDate).inDays.toString(),
                      "email": userMail,
                    ...
                    if (!isCreate) {
                      ...
                      final response = await http.post(
                        Uri.parse("http://127.0.0.1:5000/event/edit/?id=" +
                            myid.toString()),
                        headers: {
                          "accept": "application/json; charset=UTF-8",
                      ...
                      final response = await http.post(
                        Uri.parse("http://127.0.0.1:5000/event/create/"),
                        headers: {
                          "accept": "application/json; charset=UTF-8",
                          "content-type": "application/x-www-form-urlencoded",
                        },
