...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  fetchEventsTickets(String userName) async {
    ...
    final response = await http.get(
      Uri.parse("http://127.0.0.1:5000/event/showTicket/?email=" + userName),
      headers: {
  ...
  fetchEventsLiked(String userName) async {
    ...
    final response = await http.get(
      Uri.parse("http://127.0.0.1:5000/event/showSaved/?email=" + userName),
      headers: {
        'Accept': 'application/json; charset=UTF-8',
      },
    );
        ...
        child: ListTile(
          ...
          children: <Widget>[
            ...
            TextButton(
              onPressed: () async {
                final response = await http.get(
                  Uri.parse("http://127.0.0.1:5000/event/removeSaved/?email=" +
                      widget.username +
                      "&" +
                      "eid=" +
                      item.id.toString()),
